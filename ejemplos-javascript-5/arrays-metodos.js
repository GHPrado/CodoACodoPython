...
var todos = varones.concat(masVarones) //Agrega al array varones loe elementos del array masVarones

document.write("<br><br> CONCAT <br>")
document.write(varones, "<br>")
document.write(masVarones, "<br>")
document.write(todos, "<br>") 
todos = todos.concat("Julieta", "Natalia") //Sobreescribo el array todos con nuevos valores
document.write(todos, "<br>");
